...
name: study-cram
description: >
  UK 本硕商学院考前冲刺模式 —— 仅手动启动。
  考试在即（剩 1-14 天）抱佛脚式高密度复习时使用。
...
| 日期 | 时段 | 内容 | 产出 |
|---|---|---|---|
| **Day 1 ([日期])** | 上午 2h | 🔴 Top 1-2 速通 | 笔记：核心概念 3×2 |
| | 下午 2h | 🟠 Top 3-4 速通 | 笔记：核心概念 3×2 |
| **Day 2 ([日期])** | 上午 2h | 刷 1 套往年题 (2024 Final) | 踩分/踩雷清单 |
| | 下午 2h | 🔴 Top 1 变体题 + Revision lecture 精读 | 模板草稿 |
| **Day 3 ([日期])** | 上午 2h | 🟡 Top 5-7 速通 | 答题模板定稿 |
...
3. 把这些 vs 热力图对比，得出两类重点：
   - **老师强调 + 历年高频**的双重命中 topic → **必考！**
   - **老师强调但历年没考过**的 → **潜在新考点，警惕！**
...
- ❌ 看到熟悉题型就走老套路，不逐特征判定——即使题面看起来和往年一样，也要先确认 key terms 和限定条件没变再套模板
